...
public class BlueAuto extends Auto {
    ...
    public static Pose2d NONE_PICK_UP_SECOND_WOBBLE = new Pose2d(-39, -34.5, Math.toRadians(0));
    ...
    public static Pose2d SINGLE_PICK_UP_SECOND_WOBBLE = new Pose2d(-39, -34.5, Math.toRadians(0));
