...
@Autonomous(name = "Red Inside 1 Wobble", group = "Competition", preselectTeleOp = "Red TeleOp")
public class RedInside1W extends Auto {
    ...
    public static Pose2d NONE_GOING_BACK = new Pose2d(42, -42, Math.toRadians(90));
    public static Pose2d NONE_PARK = new Pose2d(10, -16, Math.toRadians(180));
