...
@Autonomous(name = "Blue Outside 2 Wobble", group = "Competition", preselectTeleOp = "Blue TeleOp")
public class BlueOutside2W extends Auto {
    ...
    public static Pose2d NONE_PICK_UP_SECOND_WOBBLE = new Pose2d(-40, 40, Math.toRadians(60));
    public static Pose2d NONE_DROP_SECOND_WOBBLE    = new Pose2d(7, 37, Math.toRadians(-90));
    public static Pose2d NONE_PARK                  = new Pose2d(3, 36, Math.toRadians(180));

    public static Pose2d SINGLE_DROP_FIRST_WOBBLE     = new Pose2d(23, 37, Math.toRadians(0));
    public static Pose2d SINGLE_GOAL                  = new Pose2d(-8, 46, Math.toRadians(0));
    public static Pose2d SINGLE_PICK_UP_SECOND_WOBBLE = new Pose2d(-39, 41, Math.toRadians(60));
    public static Pose2d SINGLE_GOAL_2                = new Pose2d(-8, 37, Math.toRadians(0));
    public static Pose2d SINGLE_MOVE_SECOND_WOBBLE    = new Pose2d(14, 37, Math.toRadians(-90));
    public static Pose2d SINGLE_PARK                  = new Pose2d(10, 37, Math.toRadians(180));
    ...
    public static Pose2d QUAD_PICK_UP_SECOND_WOBBLE   = new Pose2d(-31, 32, Math.toRadians(35));
    public static Pose2d QUAD_GOAL_3                  = new Pose2d(-7, 38, Math.toRadians(0));
    public static Pose2d QUAD_DROP_SECOND_WOBBLE      = new Pose2d(37, 52, Math.toRadians(-135));
    ...
    public void buildSteps(StarterStack stack) {
        ...
        Trajectory noneGoal = robot.drive.trajectoryBuilder(noneDropFirstWobble.end())
                ...
                .build();
        Trajectory nonePickUpSecondWobble = robot.drive.trajectoryBuilder(noneGoal.end())
        ...
        Trajectory singleGoal = robot.drive.trajectoryBuilder(singleDropFirstWobble.end())
                ...
                .build();
        Trajectory singlePickUpSecondWobble = robot.drive.trajectoryBuilder(singleGoal.end())
                ...
                .build();
        Trajectory singleGoal2 = robot.drive.trajectoryBuilder(singlePickUpSecondWobble.end())
                .addTemporalMarker(0, () -> robot.arm.setArm(ALMOST_DOWN))
                .lineToLinearHeading(SINGLE_GOAL_2)
                .build();
        Trajectory singleMoveSecondWobble = robot.drive.trajectoryBuilder(singleGoal2.end())
                .lineToLinearHeading(SINGLE_MOVE_SECOND_WOBBLE)
                .build();
        Trajectory singlePark = robot.drive.trajectoryBuilder(singleMoveSecondWobble.end().plus(new Pose2d(0, 0, Math.toRadians(-90))))
        ...
        Trajectory quadRings = robot.drive.trajectoryBuilder(quadGoal2.end())
                ...
                .addTemporalMarker(2.5, () -> robot.arm.setClaw(OPEN))
                .build();
        Trajectory quadPickUpSecondWobble = robot.drive.trajectoryBuilder(quadRings.end())
