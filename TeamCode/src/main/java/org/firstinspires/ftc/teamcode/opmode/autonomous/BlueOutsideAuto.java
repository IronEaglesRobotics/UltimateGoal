...
public class BlueOutsideAuto extends Auto {
    ...
    public static Pose2d NONE_PICK_UP_SECOND_WOBBLE = new Pose2d(-41, 41, Math.toRadians(60));
    public static Pose2d NONE_DROP_SECOND_WOBBLE    = new Pose2d(2, 46, Math.toRadians(-90));
    public static Pose2d NONE_PARK                  = new Pose2d(5, 43, Math.toRadians(180));
