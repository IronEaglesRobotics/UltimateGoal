...
public class BlueOutsideWobble extends Auto {
    ...
    public static Pose2d NONE_DROP_FIRST_WOBBLE     = new Pose2d(-3, 58, Math.toRadians(-135));
    ...
    public static Pose2d NONE_DROP_SECOND_WOBBLE    = new Pose2d(-2, 44, Math.toRadians(-90));
